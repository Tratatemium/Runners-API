...
describe("POST /auth/signup", () => {
  ...
  describe("Username validation", () => {
    ...
    ])("returns 400 for invalid username length: $username", async ({ username, message }) => {
      const res = await request(app)
        .post("/auth/signup")
  ...
  describe("Email validation", () => {
    ...
    it.each([
      { email: "test user@example.com", message: "Email must not contain whitespace." },
      { email: "invalidemail.com", message: "Email must be a valid email address." },
  ...
  describe("Password validation", () => {
    ...
    ])("returns 400 for password with invalid length", async ({ password, message }) => {
      const res = await request(app)
        .post("/auth/signup")
    ...
    it.each([
      { password: "ValidPass123", username: "pass12char", email: "pass12char@example.com" },
      { password: "a".repeat(128), username: "pass128char", email: "pass128char@example.com" },
      { password: "P@ssw0rd!#$%^&*()", username: "passspecial", email: "passspecial@example.com" },
